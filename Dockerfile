...
#CMD /usr/local/bin/gunicorn -w 40 --bind 0.0.0.0:4000 --worker-tmp-dir /dev/shm --worker-class aiohttp.GunicornUVLoopWebWorker --timeout 86400 --log-level=DEBUG server:app_factory

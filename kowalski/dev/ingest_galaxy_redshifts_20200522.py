...
if __name__ == '__main__':
    ...
    parser.add_argument('--dryrun', action='store_true', help='test before ingesting')
    ...
    collection = 'galaxy_redshifts_20200522'
    ...
    if not dry_run:
        ...
        db[collection].create_index([('z', pymongo.ASCENDING)], background=True)

    # number of records to insert
    batch_size = 4096

    _location = '/_tmp/galaxy_redshifts_20200522/'

    files = glob.glob(os.path.join(_location, 'combined_n.csv'))
